...
def main():
    ...
    # Define the specific datasets we want to compare (20K versions)
    datasets_to_compare = {
        "top_20000": {
            "label": "Top 20K (Most Influential)",
            "color": "#d62728",  # Red
            "linestyle": "-",
            "linewidth": 2.5
        },
        "bottom_20000": {
            "label": "Bottom 20K (Least Influential)", 
            "color": "#1f77b4",  # Blue
            "linestyle": "--",
            "linewidth": 2.5
        },
        "middle_20000": {
            "label": "Middle 20K (Median Influence)",
            "color": "#ff7f0e",  # Orange
            "linestyle": "-.",
            "linewidth": 2.5
        },
        "random_20000_seed8675309": {
            "label": "Random 20K (Baseline)",
            "color": "#2ca02c",  # Green
            "linestyle": ":",
            "linewidth": 3
        }
    ...
    # Check for alternative random naming pattern and use it if the first doesn't exist
    random_20k_dir = BASE_DIR / "random_20000_seed8675309"
    if not random_20k_dir.exists():
        alt_random_20k_dir = BASE_DIR / "random_20000_seed_8675309"
        if alt_random_20k_dir.exists():
            datasets_to_compare["random_20000_seed_8675309"] = datasets_to_compare.pop("random_20000_seed8675309")
            datasets_to_compare["random_20000_seed_8675309"]["label"] = "Random 20K (Baseline)"
            print("Using alternative random directory naming: random_20000_seed_8675309")
    ...
    plot_path = PLOT_DIR / "training_trajectories_20k_comparison.png"
    plt.savefig(plot_path, dpi=300, bbox_inches='tight', 
                facecolor='white', edgecolor='none')
    print(f"\nPlot saved to: {plot_path}")
    
    # Also save as PDF for publications
    pdf_path = PLOT_DIR / "training_trajectories_20k_comparison.pdf"
